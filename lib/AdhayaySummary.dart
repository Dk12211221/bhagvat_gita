                    ...
                    child: Consumer(
                      builder: (context,summarylang sprovider,child) {
                        return Column(
                          ...
                          children: [
                            Text("Name of Adhayay : ${allchaplist[selsectedindex].name} (${allchaplist[selsectedindex]
                                .name_translation})",style: TextStyle(color:themechanger.isDark?
                            Colors.white:Colors.black,fontSize: 18,fontWeight: FontWeight.bold ),),

                            SizedBox(height: 10,),
                              Center(child: Image(image: AssetImage(images[selsectedindex]),
                                height: MediaQuery.of(context).size.height/3,width: MediaQuery.of(context)
                                    .size.width/2,fit: BoxFit.fill,)),

                           SizedBox(height: 10,),
                              Text("Name Meaning : ${allchaplist[selsectedindex].name_meaning} ",style:
                              TextStyle(color:themechanger.isDark?Colors.white:Colors.black,fontSize: 18,
                                  fontWeight: FontWeight.bold ),),

                            SizedBox(height: 30,),
                              Text("Summary :",style: TextStyle(color:themechanger.isDark?
                              Colors.white:Colors.black,fontSize: 18,fontWeight: FontWeight.bold ),),
                            ...
                            SizedBox(height: 10,),
                              Row(
                                children: [
                                  ...
                                  }, child: Text("Hindi",style: TextStyle(color:Colors.redAccent,fontSize: 16,
                                      fontWeight: FontWeight.bold ))),
                                    SizedBox(width: 50,),
                                  TextButton(onPressed: () {
                                          sprovider.summarylanfun();
                                  }, child: Text("English",style: TextStyle(color: Colors.redAccent,fontSize: 16,
                                      fontWeight: FontWeight.bold ))),
                                ],
                              ),
                              SizedBox(height: 20,),
                              Text(sprovider.sl?allchaplist[selsectedindex].chapter_summary_hindi:allchaplist
                              [selsectedindex].chapter_summary,
                                style: TextStyle(color:themechanger.isDark?Colors.white:Colors.black,fontSize: 16,
                                    fontWeight: FontWeight.bold ),),
                                    ...
                                    return Center(child: ElevatedButton(
                                      style: ButtonStyle(backgroundColor: WidgetStateColor.resolveWith((states) {
                                        ...
                                        Navigator.of(context).push(MaterialPageRoute(builder: (context) =>
                                            VersePage(selctedindex: selsectedindex),));
                                        }, child: Padding(
                                          padding: const EdgeInsets.all(8.0),
                                          child: Text("Verse",style: TextStyle(color:Colors.red,fontSize: 16,
                                              fontWeight: FontWeight.bold ),),
                                        )));
                                  }
                                ),
