          ...
          builder: (context,BookmarkPreferences bprovider,child) {
            ...
            return Scaffold(
              ...
              Padding(
                ...
                child: Center(child: Text("You dont'have eny Bookmark Yet ..",style: TextStyle
                ...
                child: Column(
                  children: [
                    Text("All BookMark",style: TextStyle(color:themechanger.isDark?
                      ...
                      child: SizedBox(
                        child: ListView.builder(
                          ...
                          return Padding(
                            ...
                            child: ListTile(
                              title: Text(bprovider.stringList[index],style: TextStyle
                                (color:themechanger.isDark?Colors.white:Colors.black,fontSize: 18,
                                  fontWeight: FontWeight.bold )),
                              trailing: IconButton(onPressed: () => bprovider.removeStringList(bprovider.stringList[index]),
                                icon: Icon(Icons.cancel,color: themechanger.isDark?Colors.white:Colors.black,),),
                            ),
                          );
                        },),
                      ),
