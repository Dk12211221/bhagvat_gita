...
import 'package:departure_pr4/pages/BookmarkPage.dart';
                  ...
                  builder: (context,All_chapprovider allprovider,child) {
                    return Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text("Choose Your Adhayay ..",style: TextStyle(color:themechanger.isDark?
                                  ...
                                  return InkWell(
                                    onTap: () {
                                      ...
                                      Navigator.of(context).push(MaterialPageRoute(builder: (context) =>
                                          AdhayaySummary(selsectedindex: index)));
                                    },
                                    child: Padding(
                                      ...
                                      child: Card(
                                        ...
                                        child: ListTile(
                                          title: Text(allchaplist[index].name,style: TextStyle(color: themechanger.isDark?
                                          Colors.white:Colors.black,fontSize: 16,fontWeight: FontWeight.w700),),
                                          subtitle: Text(allchaplist[index].name_translation,style: TextStyle(color: themechanger.isDark?
                                          Colors.white:Colors.black,fontSize: 14,fontWeight: FontWeight.w700),),
                                          leading: Text("${allchaplist[index].chapter_number} .",style: TextStyle(color: themechanger.isDark?
