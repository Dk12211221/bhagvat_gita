...
class All_chaptersModal{
  ...
  All_chaptersModal({required this.chapter_number,required this.chapter_summary,
    required this.chapter_summary_hindi,required this.id,required this.image_name,
    required this.name,required this.name_meaning,required this.name_translation,
    required this.verses_count,required this.json_path});
  ...
  String toString(){
  return "chapter_number:$chapter_number,chapter_summary:$chapter_summary,"
      "chapter_summary_hindi:$chapter_summary_hindi,id:$id,image_name:$image_name,"
      "name:$name,name_meaning:$name_meaning,name_translation:$name_translation,"
      "verse_count:$verses_count,json_path:$json_path";
  }
