...
import 'package:departure_pr4/pages/HomePage.dart';
                    ...
                    child: SizedBox(height: 200,width: 200,
                      child: ClipRRect
                        (borderRadius: BorderRadius.circular(20),
                          child: Image(image: AssetImage("assets/Bhagvad gita image.jpg"),height:
                          double.infinity,width: double.infinity,fit: BoxFit.cover,)),
                    ),
                  ),
                ),
                SizedBox(height: 70,),
                  ...
                  child: AnimatedBuilder(
                    ...
                    builder: (context, child) {
                      ...
                      child:Text("श्रीमद्भगवद्गीता",
                        style: TextStyle(color:themechanger.isDark?Colors.white:Colors.black,fontSize: 22,
